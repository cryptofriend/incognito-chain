...
// END VARIABLE & CONSTANT network MAINNET

// VARIABLE & CONSTANT network TESTNET
const (
	Testnet                       = 0x16
	TestnetName                   = "testnet"
	TestnetDefaultPort            = "9444"
	TestNetMaxShardCommitteeSize  = 4
	TestNetMinShardCommitteeSize  = 3
	TestNetMaxBeaconCommitteeSize = 4
...
func init() {
	...
	for i := 0; i < TestNetMaxBeaconCommitteeSize; i++ {
	...
	for i := 0; i < TestNetActiveShards; i++ {
		for j := 0; j < TestNetMaxShardCommitteeSize; j++ {
